...
##Below are examples of extracting numbers and IP addresses from a large text in Python.
...
```
##Next, I will demonstrate reticulation of R and Python.
```{R}
library(reticulate)
capitol<-"My friends and I went to visit the capitol."
```
```{python}
capitol="It was about a 2 mile walk."
print(r.capitol,capitol)
```
```{R}
cat(c(capitol,py$capitol))
```

##Here is a Picture of Us at the Capitol!

![](/post/2020-12-07-python_files/IMG_9420.jpg){width=100% height=100%}